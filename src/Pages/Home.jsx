  ...
  return(
    <div>
      {/* start main content */}
        ...
        {/* end main content */}
        <div className="container mx-auto h-[120vh] mt-11 flex flex-col items-center md:grid md:grid-cols-12 md:grid-rows-12">

          <div className="col-start-8 col-end-12">
            <img src={banner_1} alt="" />
          </div>

          <p className="text-3xl md:text-5xl flex flex-col gap-3 text-[#475569] col-start-5 col-end-10"><span>Clothing</span><span>Collection 2025</span><span className="text-sm underline">SHOP NOW</span></p>

          <div className="row-start-7 col-start-2 col-end-6" >
          ...
          <div className="row-start-9 col-start-8 col-end-12" >
            <img src={banner_3} alt="" />
          </div>

            <p className="text-3xl md:text-5xl flex flex-col gap-3 text-[#475569] row-start-10 col-start-7 col-end-10">Shoes Spring <span>2025</span> <span className="text-sm underline">SHOP NOW</span></p>
        </div>
    </div>
  )
}
