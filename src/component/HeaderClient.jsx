    ...
    return (
        <ul className="my-5 flex flex-col lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:justify-between">
            ...
            <Typography
                ...
                variant="small"
                color="blue-gray"
                className="font-medium lg:flex lg:gap-7 lg:items-center text-center"
            >
                    ...
                    <Menu>
                        ...
                        <MenuList>
                            ...
                            <MenuItem className="flex items-center gap-2 ">
                                ...
                                <Typography variant="small" className="font-medium" onClick={()=>{navigate("/signin");setLogged(false);Swal.fire("Logged Out");}}>
                                    Sign Out
                                </Typography>
                            </MenuItem>
                        </MenuList>
